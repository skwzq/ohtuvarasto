...
class TestVarasto(unittest.TestCase):
    ...
    def test_konstruktori_ei_aseta_saldoa_liian_suureksi(self):
    ...
    def test_lisays_ei_pienenna_saldoa(self):
    ...
    def test_ottaminen_palauttaa_negatiivisella_maaralla_nollan(self):
        saatu_maara = self.varasto.ota_varastosta(-1)

        self.assertAlmostEqual(saatu_maara, 0)

    def test_ottaminen_palauttaa_enintaan_saldon(self):
        saatu_maara = self.varasto.ota_varastosta(2)
    ...
    def test_ottaminen_ei_lisaa_saldoa(self):
